...
public class AESEncryptUtil2 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(AESEncryptUtil2.class);
...
//        String message = "1232454458";
//        byte[] msgBytes = message.getBytes();
//
//        Long startTime = System.currentTimeMillis();
//        String encodedMsg = new String(Base64.getEncoder().encode(msgBytes));
//        System.out.println("base64编码时间："+(System.currentTimeMillis()-startTime));
//        System.out.println("base64编码输出:" + encodedMsg);
//
//        Long decodedStartTime = System.currentTimeMillis();
//        byte[] decodedBytes = Base64.getDecoder().decode(encodedMsg);
//        System.out.println("base64解码时间："+(System.currentTimeMillis()-decodedStartTime));
//        String decodedMsg = new String(decodedBytes);
//        System.out.println("base64解码输出："+decodedMsg);
        
//        Long startTime = System.currentTimeMillis();
//        String encryptedMessage = AESEncryptUtil2.AesEcbEncrypt(message);
//        System.out.println("加密时间耗时："+(System.currentTimeMillis()-startTime));
//        System.out.println("加密结果为："+ encryptedMessage);
//
//        Long decodeStartTime = System.currentTimeMillis();
//        String dencryptedMessage = AESEncryptUtil2.AesEcbDecrypt(encryptedMessage);
//        System.out.println("解密时间耗时："+(System.currentTimeMillis()-decodeStartTime));
//        System.out.println("解密结果为:"+dencryptedMessage);
